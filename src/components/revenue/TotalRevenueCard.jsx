...
/**
 * TotalRevenueCard - Displays total revenue for all years in a card format
 */
const TotalRevenueCard = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mb-6">
      <h2 className="text-xl font-bold text-gray-800 mb-4">Total Revenue Projection</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {yearRange.map(year => (
          <div key={year} className="bg-green-50 p-4 rounded-md border border-green-200">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">{year}</h3>
              <div className="space-y-1">
                <p className="text-sm text-green-500">Projected Range:</p>
